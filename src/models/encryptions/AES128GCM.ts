...
export class AES128GCM implements EncryptionAlgorithm {
  /**
   * Encrypts plaintext using AES-128-GCM with a random IV and returns a base64-encoded string containing both the IV and ciphertext.
   * @param plaintext - The plaintext string to encrypt.
   * @param base64Key - The base64-encoded 16-byte key for AES-128 encryption.
  ...
  /**
   * Decrypts a base64-encoded string containing the IV and ciphertext encrypted with AES-128-GCM.
